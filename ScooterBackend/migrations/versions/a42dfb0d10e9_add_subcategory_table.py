...
Revision ID: a42dfb0d10e9
Revises: 910caa61f594
Create Date: 2024-09-26 21:03:10.177087
...
revision = "a42dfb0d10e9"
down_revision = "910caa61f594"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("id_category", sa.Integer(), nullable=False),
        sa.Column("id_subcategory_thirst_level", sa.Integer(), nullable=False),
        sa.Column("id_subcategory_second_level", sa.Integer(), nullable=False),
        sa.Column("explanation_product", sa.Text(), nullable=True),
        sa.Column("brand_mark", sa.String(length=150), nullable=True),
