...
Revision ID: 6079a56aa5ea
Revises: 6f68899b2f35
Create Date: 2025-01-28 01:53:14.135360
...
revision = "6079a56aa5ea"
down_revision = "6f68899b2f35"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("type_pr", sa.Integer(), nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ["type_pr"], ["Typemoto.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
