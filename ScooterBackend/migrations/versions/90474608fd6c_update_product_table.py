...
Revision ID: 90474608fd6c
Revises: 8a4be15a5dec
Create Date: 2024-10-25 15:39:30.976420
...
revision = "90474608fd6c"
down_revision = "8a4be15a5dec"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("id_s_sub_category", sa.Integer(), nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ["id_s_sub_category"], ["Subsubcategory.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
