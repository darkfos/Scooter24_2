"""update product table and add model, brand, mark tables

Revision ID: f4e143594c13
Revises: 782301dabede
Create Date: 2024-10-02 20:49:26.959128
...
revision = "f4e143594c13"
down_revision = "782301dabede"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("id_category", sa.Integer(), nullable=True),
        sa.Column("id_subcategory_thirst_level", sa.Integer(), nullable=True),
        sa.Column("id_subcategory_second_level", sa.Integer(), nullable=True),
