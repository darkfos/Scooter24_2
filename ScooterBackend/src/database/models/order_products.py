...
class OrderProducts(MainBase):
    ...
    id_product: Mapped[int] = mapped_column(ForeignKey("Product.id", ondelete="CASCADE"), type_=Integer)
    id_order: Mapped[int] = mapped_column(ForeignKey("Order.id", ondelete="CASCADE"), type_=Integer)
