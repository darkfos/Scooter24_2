...
class MarkService:
    ...
    @staticmethod
    async def create_a_new_mark(engine: IEngineRepository, token: str, new_mark_data: MarkBase, token_data: dict = dict()) -> NoReturn:
        """
    ...
    @redis
    @staticmethod
    async def get_all_marks(engine: IEngineRepository, redis_search_data: dict = {}) -> Union[List, List[MarkBase]]:
        """
    ...
    @redis
    @staticmethod
    async def get_mark_by_id(engine: IEngineRepository, id_mark: int, redis_search_data: dict = {}) -> MarkBase:
        """
