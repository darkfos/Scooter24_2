...
from src.api.core.ss_category_catalog.service.sub_subcategories_service import (
...
async def create_a_new_sub_subcategory(
    ...
    await SubSubCategoryService.create_new_sub_subcategory(
        engine=engine, token=admin_data, new_s_sc=new_sub_subcategory
    )
...
async def get_all_ss_category_by_subcategory(
    engine: Annotated[IEngineRepository, Depends(EngineRepository)], id_sc: int
) -> AllSubSubCategory:
    return await SubSubCategoryService.get_sub_subcategory_by_id_s(
        engine=engine,
        id_s=id_sc,
        redis_search_data="get_all_subcategories_by_id_%s" % id_sc,
    )
...
async def get_all_subcategories(
    ...
    return await SubSubCategoryService.get_all_sub_subcategory(
        engine=engine, redis_search_data="get_all_sub_subcategories"
    )
...
async def delete_sscategory_by_id(
    ...
    await SubSubCategoryService.delete_sub_subcategory_by_id(
        engine=engine, token=admin_data, id_s_sc=id_ss_category
    )
