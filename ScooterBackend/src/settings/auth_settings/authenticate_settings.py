...
class Authentication:
    ...
    jwt_secret_refresh_key: Union[str, Type[SettingsDescriptor], int] = (
        SettingsDescriptor()
    )
    time_work_secret_key: Union[str, Type[SettingsDescriptor], int] = (
        SettingsDescriptor()
    )
    time_work_refresh_secret_key: Union[str, Type[SettingsDescriptor], int] = (
        SettingsDescriptor()
    )
