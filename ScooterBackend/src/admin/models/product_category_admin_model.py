...
class ProductCategoryModelView(ModelView, model=ProductCategory):
    ...
    name_plural: str = "Категории товара"
    icon: str = "fa fa-puzzle-piece"
    category: str = "Товар"

    column_list: List[Any] = [
        ProductCategory.id,
        ProductCategory.id_category,
        ProductCategory.id_product,
        ProductCategory.category_information,
        ProductCategory.product_information,
    ]
    column_labels: dict = {
